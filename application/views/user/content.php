                    ...
                    <div class="card">
                        <div class="body">
                            <div class="w_summary">
                                ...
                                <div class="s_detail">
                                    <h2 class="font700 mb-0"><a href="<?php echo base_url('salary/view_salary_e/'.$nik); ?>"><?php echo $count4; ?></a></h2>
                                    <span class="icon-user"></i> Total data payslip</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="body">
                            <div class="w_summary">
                                ...
                                <div class="s_detail">
                                    <h2 class="font700 mb-0"><a href="#"><?php echo $count; ?></a></h2>
                    ...
                    <div class="card">
                        <div class="body">
                            <div class="w_summary">
                                ...
                                <div class="s_detail">
                                    <h2 class="font700 mb-0"><a href="#"><?php echo $count4; ?></a></h2>
